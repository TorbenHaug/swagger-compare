...
public class SecuritySchemesCompareHolder extends AbstractCompareHolder<Map<String, SecurityScheme>> {
    ...
    @Override
    public ICompareResult compare(Map<String, SecurityScheme> left, Map<String, SecurityScheme> right) {
        ...
        return this.referableCompare(leftValue, rightValue, securitySchemeCompareHolder);
    }
}
